...
namespace Disaheim1.Repositories
{
    public class ValuableRepository : IPersistable
    {
        ...
        public void Save()
        {
            ...
            using (StreamWriter outputFile = new StreamWriter("ValuableRepository.txt"))
            {
        ...
        public void Load()
        {
            ...
            StreamReader sr = new StreamReader(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "ValuableRepository.txt"));
